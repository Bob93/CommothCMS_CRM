            ...
            <nav id="primary-menu" class="style-2">
                ...
                <div class="container clearfix">
                    ...
                    <ul>
                        ...
                        <?php echo $this->GetCurrentPage(); ?>
                        <li><a href="#"><div>Users</div></a>
                            <ul>
                                <li><a href="#"><div><i class="icon-stack"></i>Overview</div></a>
                                <li><a href="#"><div><i class="icon-adjust"></i>Create User(s)</div></a></li>
                                <li><a href="#"><div><i class="icon-adjust"></i>Delete User(s)</div></a></li>
                                <li><a href="#"><div><i class="icon-wrench"></i>Edit User(s)</div></a></li>
                                <li><a href="#"><div><i class="fa fa-times fa-x2"></i>Suspend User(s)</div></a></li>
                            </ul>
                        </li>
